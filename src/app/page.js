      ...
      <div className="space-y-8 animate-fade-in">
        <div>
          ...
          <p className="text-slate-500 dark:text-slate-400 mt-1.5 text-base font-bold">
            Your own resume, matched against real roles — nothing you upload is visible to anyone else.
          </p>
        </div>
        ...
        <div className="glass-panel rounded-2xl shadow-sm p-6 space-y-3">
          ...
          <p className="text-sm text-slate-600 dark:text-slate-350 leading-relaxed font-medium">
            Upload your resume once and get a real match score against a role, tailored interview prep, and
            live job postings for that role ranked by how closely they actually fit your background —
            powered by the same vector retrieval used on the recruiter side, scoped privately to just you.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <Link
            ...
            className="glass-panel p-6 rounded-2xl shadow-sm hover:scale-[1.02] transition duration-300 flex flex-col gap-4 group md:col-span-2"
          >
            ...
            <div>
              <h3 className="font-extrabold text-lg dark:text-white mb-1">Career Assistant</h3>
              <p className="text-sm text-slate-500 dark:text-slate-400 font-medium leading-relaxed">
                Upload your resume, tell it the role you want — get your match score, missing skills, tailored
                interview questions, and live matching job postings, all in one pass.
              </p>
            </div>
          ...
          >
            ...
            <div>
              <h3 className="font-extrabold text-lg dark:text-white mb-1">Document Summarizer</h3>
              <p className="text-sm text-slate-500 dark:text-slate-400 font-medium leading-relaxed">
                Get a structured summary of your resume or any job description you're considering.
              </p>
            </div>
            <span className="text-xs font-bold text-brand-600 dark:text-brand-400 flex items-center gap-1 mt-auto group-hover:gap-2 transition-all">
              Open <ArrowRight className="w-3.5 h-3.5" />
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
          <Link href="/interview-prep" className="glass-panel p-5 rounded-2xl flex items-start gap-4 hover:scale-[1.01] transition">
            ...
            <div>
              <h4 className="font-bold text-sm dark:text-white">Interview Prep</h4>
              <p className="text-xs text-slate-500 dark:text-slate-400 mt-1 font-medium leading-relaxed">
                Generate technical and behavioral interview questions for any role, on its own.
              </p>
            </div>
          </Link>
          <Link href="/convert" className="glass-panel p-5 rounded-2xl flex items-start gap-4 hover:scale-[1.01] transition">
            <div className="p-2.5 bg-emerald-550/10 text-emerald-600 dark:text-emerald-450 rounded-xl border border-emerald-500/20 shrink-0">
              <RefreshCw className="w-5 h-5" />
            </div>
            <div>
              <h4 className="font-bold text-sm dark:text-white">Document Converter</h4>
              <p className="text-xs text-slate-500 dark:text-slate-400 mt-1 font-medium leading-relaxed">
                Convert your resume or cover letter between PDF and Word.
              </p>
            </div>
          </Link>
        </div>
